...
```bash
npx yazzi-ui@latest add [component]
```
...
```txt
Usage: yazzi-ui add [options] [components...]
...
```txt
Usage: yazzi-ui diff [options] [component]
